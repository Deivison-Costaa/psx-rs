...
- [x] 10.72 Diagnostico: parse_cue nao suporta multi-file (cue original do Rayman tem 51 tracks) (descobriu-se na 0148)
- [x] 10.73 Diagnostico: VSync timeout no Rayman — contador do jogo em 0x801DF2CC nunca e incrementado; handler nao despacha (iter 0148)
