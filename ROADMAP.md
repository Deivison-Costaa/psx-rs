...
- [x] 4.4h Crash $ra=4 era load pendente sobre delay slot (iter 0111)
...
- [x] 4.4e Handler 0x80000080 despacha para tabela de eventos do kernel (iter 0095)
- [x] 4.4f Interrupcao no delay slot sequestrava handler (iter 0103)
- [x] 4.4g Ciclos do load: espera VSync cobria 69% de frame (iter 0104)
...
- [x] 4.4n Troca do GetStat correta porto a porto (iter 0119)
...
- [x] 4.4v Dois eventos CD (F0000003h spec 10h/200h) ficam ready e ninguem consome; corrida intra-step confirmada (iter 0127)
- [ ] 4.4w Corrigir ordem de IRQ no Cpu::step (IRQ antes da instrucao, nao depois)
