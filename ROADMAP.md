...
- [ ] 10.47 Lacos de espera da BIOS (`0x80059DA4`/`0x80059D54`) saem por timeout: 0x8000 giros < frame de ~230 k passos (0114)
...
- [ ] 10.80 `0x00004A1C` limpa bit 0 de I_STAT antes do hook do jogo em 570 de 1028 casos (0153)
