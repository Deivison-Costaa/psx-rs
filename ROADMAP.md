...
- [x] 4.4s Setor Mode2/Form1 era lido de 010h (offset do Mode1); agora o offset sai do byte de modo (iter 0124)
- [ ] 4.4t Shell para no laco 0x8004205C..0x800422DC apos SetGraphDebug, sem ler SYSTEM.CNF; tela de licenca ja renderiza
