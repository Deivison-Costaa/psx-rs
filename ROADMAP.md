...
- [x] 4.4h $ra=4: load pendente sobre delay slot (iter 0111)
- [x] 4.4a Boot da BIOS no psx-cli (iter 0079)
- [x] 4.4b scheduler + vblank + IRQ0 (iter 0080)
- [x] 4.4c BIOS nunca escreve I_MASK (iter 0085)
- [x] 4.4d I_MASK=0: IRQs nunca vetoram (iter 0096)
- [x] 4.4e Handler 80000080 despacha p/ tabela do kernel (iter 0095)
- [x] 4.4f IRQ no delay slot sequestrava handler (iter 0103)
- [x] 4.4g Ciclos do load; VSync cobria 69% do frame (iter 0104)
- [x] 4.4i IRQ2 do CD-ROM sobe por borda (iter 0114)
- [x] 4.4j sh/lhu no SIO0 perdiam byte alto (iter 0115)
- [x] 4.4k DICR: flags, bit31 e IRQ3 (iter 0116)
- [x] 4.4l Canal 2 DMA device->RAM (iter 0117)
- [x] 4.4m lhu/sh nos timers caiam no sumidouro (iter 0118)
- [x] 4.4n GetStat correto porto a porto (iter 0119)
- [x] 4.4o Referencia DuckStation: falta GetID (iter 0120)
- [x] 4.4p 1a resposta do CD-ROM pelo scheduler; GetID aparece (iter 0121)
- [x] 4.4q GetID Licensed:Mode2+SCEA; retry acaba (iter 0122)
...
- [x] 4.4v Eventos 10h/200h ready antes do TestEvent (iter 0127)
- [x] 4.4w Descritor do TestEvent do shell (iter 0128)
- [x] 4.4x DeliverEvent(F0000003h,20h); shell desenha (iter 0129)
- [x] 4.4y Tela SCE igual a referencia; congela 120M→200M (iter 0130)
- [x] 4.4z Reads entregavam setor N+150; TMD virava lixo (iter 0131)
