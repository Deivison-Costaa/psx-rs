...
- [ ] 0240.1 CD-ROM rapido demais contra o DuckStation: seek medio (~370 setores) 52 ms vs ~100 ms, releitura 15 ms vs 20-60 ms, Pause em 2x 34 ms vs 39 ms; cargas do GT2/TR2/TR3 terminam 0,5-1,2 s antes (0240)
- [ ] 0240.2 FF9 disco 1: FMVs depois de NEW GAME sem som (~94-210 s e 420-490 s emulados); a FMV antes do titulo e o som do jogo funcionam (0240)
