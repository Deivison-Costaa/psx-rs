<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/cpuspecifications.md
...
- L1: CPU Specifications
- L2: CPU
- L11: System Control Coprocessor (COP0)
- L19: CPU Registers
- L44: R29 (SP) - Full Decrementing Wasted Stack Pointer
- L74: CPU Opcode Encoding
- L75: Primary opcode field (Bit 26..31)
- L87: Secondary opcode field (Bit 0..5) (when Primary opcode = 00h)
- L99: Opcode/Parameter Encoding
- L127: Coprocessor Opcode/Parameter Encoding
- L148: Illegal Opcodes
- L156: CPU Load/Store Opcodes
- L157: Load instructions
- L171: Caution - Load Delay
- L180: Load Timing
- L201: Load Shadow
- L219: Store instructions
- L229: Caution - 8/16-bit writes to certain IO registers
- L235: Load/Store Alignment
- L240: Unaligned Load/Store
- L257: Unaligned Load/Store (Details)
- L284: CPU ALU Opcodes
- L285: arithmetic instructions
- L297: comparison instructions
- L305: logical instructions
- L316: shifting instructions
- L329: Multiply/divide
- L379: CPU Jump Opcodes
- L380: jumps and branches
- L400: JALR cautions
- L409: exception opcodes
- L421: CPU Coprocessor Opcodes
- L422: Coprocessor Instructions (COP0..COP3)
- L438: Caution - Load Delay
- L446: Caution - Store Delay
- L462: CPU Pseudo Opcodes
- L463: Pseudo instructions (native/spasm)
- L487: Pseudo instructions (nocash/a22i, not present on most other assemblers)
- L523: Directives (nocash)
- L536: Directives (native)
- L557: Syntax for unknown assembler (for pad.s)
- L568: COP0 - Register Summary
- L569: COP0 Register Summary
- L589: COP0 - Exception Handling
- L590: cop0r13 - CAUSE - (Read-only, except, Bit8-9 are R/W)
- L624: cop0r12 - SR - System status register (R/W)
- L670: cop0r14 - EPC - Return Address from Trap (R)
- L687: Interrupts vs GTE Commands
- L712: cop0cmd=10h - RFE opcode - Prepare Return from Exception
- L730: cop0r8 - BadVaddr - Bad Virtual Address (R)
- L736: Exception Vectors (depending on BEV bit in SR register)
- L752: Exception Priority
- L774: COP0 - Misc
- L775: cop0r15 - PRID - Processor Revision Identifier (R)
- L784: cop0r6 - TAR - Target Address (R)
- L790: cop0r0..r2, cop0r4, cop0r10, cop0r32..r63 - N/A
- L796: cop0cmd=01h,02h,06h,08h - TLBR,TLBWI,TLBWR,TLBP
- L800: jf/jt cop0flg,dest - conditional cop0 jumps
- L801: mov [mem],cop0reg / mov cop0reg,[mem] - coprocessor cop0 load/store
- L805: cop0r16-r31 - Garbage
- L819: COP0 - Debug Registers
- L824: cop0r7 - DCIC - Debug and Cache Invalidate Control (R/W)
- L854: cop0r7.bit12-13 - Jump Redirection Note
- L870: cop0r5 - BDA - Breakpoint Data Address (R/W)
- L871: cop0r9 - BDAM - Breakpoint Data Address Mask (R/W)
- L874: cop0r3 - BPC - Breakpoint Program Counter (R/W)
- L875: cop0r11 - BPCM - Breakpoint Program Counter Mask (R/W)
- L878: Note (BREAK Opcode)
- L884: Note (LibCrypt)
- L890: Note (Cheat Devices/Expansion ROMs)
