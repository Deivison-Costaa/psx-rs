<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/graphicsprocessingunitgpu.md
...
- L1: Graphics Processing Unit (GPU)
- L25: GPU I/O Ports, DMA Channels, Commands, VRAM
- L26: GPU I/O Ports (1F801810h and 1F801814h in Read/Write Directions)
- L41: GPU Timers / Synchronization
- L46: GPU-related DMA Channels (DMA2 and DMA6)
- L57: GPU Command Summary
- L91: Clear Cache
- L102: Quick Rectangle Fill
- L119: VRAM Overview / VRAM Addressing
- L139: GPU Render Polygon Commands
- L207: Notes
- L219: GPU Render Line Commands
- L245: Note
- L252: Wire-Frame
- L258: GPU Render Rectangle Commands
- L302: Texture Origin and X/Y-Flip
- L313: Note
- L324: GPU Rendering Attributes
- L325: Vertex (Parameter for Polygon, Line, Rectangle commands)
- L342: Color Attribute (Parameter for all Rendering commands, except Raw Texture)
- L356: Texpage Attribute (Parameter for Textured-Polygons commands)
- L366: Clut Attribute (Color Lookup Table, aka Palette)
- L377: GP0(E1h) - Draw Mode setting (aka "Texpage")
- L406: GP0(E2h) - Texture Window setting
- L437: GP0(E3h) - Set Drawing Area top left (X1,Y1)
- L438: GP0(E4h) - Set Drawing Area bottom right (X2,Y2)
- L450: GP0(E5h) - Set Drawing Offset (X,Y)
- L463: GP0(E6h) - Mask Bit Setting
- L480: Note
- L488: GPU Memory Transfer Commands
- L494: VRAM to VRAM blitting - command 4 (100)
- L503: CPU to VRAM blitting - command 5 (101)
- L514: VRAM to CPU blitting - command 6 (110)
- L525: Masking and Rounding for FILL Command parameters
- L549: Masking for COPY Commands parameters
- L572: Notes
- L582: Wrapping
- L591: GPU Other Commands
- L592: GP0(1Fh) - Interrupt Request (IRQ1)
- L602: GP0(03h) - Unknown?
- L606: GP0(00h) - NOP (?)
- L619: GP0(04h..1Eh,E0h,E7h..EFh) - Mirrors of GP0(00h) - NOP (?)
- L626: GPU Display Control Commands (GP1)
- L632: GP1(00h) - Reset GPU
- L652: GP1(01h) - Reset Command Buffer
- L658: GP1(02h) - Acknowledge GPU Interrupt (IRQ1)
- L664: GP1(03h) - Display Enable
- L674: GP1(04h) - DMA Direction / Data Request
- L683: Display start/end
- L694: GP1(05h) - Start of Display area (in VRAM)
- L711: GP1(06h) - Horizontal Display range (on Screen)
- L749: GP1(07h) - Vertical Display range (on Screen)
- L770: GP1(08h) - Display mode
- L792: GP1(10h) - Read GPU internal register
- L793: GP1(11h..1Fh) - Mirrors of GP1(10h), Read GPU internal register
- L828: GP1(09h) - Set VRAM size (v2)
- L847: GP1(20h) - Set VRAM size (v1)
- L854: GP1(0Bh) - Unknown/Internal?
- L861: GP1(0Ah,0Ch..0Fh,21h..3Fh) - N/A
- L864: GP1(40h..FFh) - N/A (Mirrors)
- L867: Mis-Centered PAL Games (wrong GP1(06h)/GP1(07h) settings)
- L886: GPU Status Register
- L887: 1F801814h - GPUSTAT - GPU Status Register (R)
- L923: Note
- L926: Ready Bits
- L946: GPU Versions
- L947: Summary of GPU Differences
- L982: Shaded Textures
- L992: Memory/Rendering Timings
- L1004: X/Y-Flip and PSone 2 MB VRAM
- L1015: GPU Detection (and optional VRAM size switching)
- L1041: GP0(02h) FillVram
- L1069: GPU Depth Ordering
- L1070: Absent Depth Buffer
- L1078: Simple Ordering
- L1084: Depth Ordering Table (OT)
- L1091: Initializing an empty OT (via DMA6)
- L1110: Inserting Entries (Passing GTE data to the OT) (by software)
- L1128: Sending the OT to the GPU (via DMA2-linked-list mode)
- L1140: GPU Video Memory (VRAM)
- L1141: Framebuffer
- L1175: Texture Bitmaps
- L1203: Texture Palettes - CLUT (Color Lookup Table)
- L1218: Texture Color Black Limitations
- L1234: GPU Texture Caching
- L1250: Cache blocks
- L1263: Cache entries
- L1286: GPU Timings
- L1287: Nominal Video Clock
- L1299: Vertical Video Timings
- L1311: Vertical Refresh Rates
- L1336: Video Clock
- L1345: Vertical Timings
- L1354: Horizontal Timings
- L1384: Frame Rates
- L1390: Note
- L1396: GPU (MISC)
- L1397: GP0(20h..7Fh) - Render Command Bits
- L1410: Perspective (in-)correct Rendering
- L1425: Perspective correct Rendering
- L1443: 24bit RGB to 15bit RGB Dithering (enabled in Texpage attribute)
- L1459: Shading
- L1467: Semi-transparency
- L1489: Modulation (also known as Texture Blending)
- L1507: Draw to display enable
