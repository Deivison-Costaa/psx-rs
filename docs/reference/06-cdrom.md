<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/cdromdrive.md
...
- L1: CDROM Drive
- L2: Playstation CDROM I/O Ports
- L5: Playstation CDROM Commands
- L19: General CDROM Disk Format
- L24: Playstation CDROM Coprocessor
- L29: CDROM Controller I/O Ports
- L58: `0x1f801800` (read, all banks): `HSTS`
- L59: `0x1f801800` (write, all banks): `ADDRESS`
- L72: `0x1f801801` (write, bank 0): `COMMAND`
- L94: `0x1f801802` (write, bank 0): `PARAMETER`
- L103: `0x1f801803` (write, bank 0): `HCHPCTL`
- L114: `0x1f801802` (read, all banks): `RDDATA`
- L131: `0x1f801801` (read, all banks): `RESULT`
- L143: `0x1f801803` (read, banks 1 and 3): `HINTSTS`
- L171: `0x1f801803` (read, banks 0 and 2): `HINTMSK`
- L172: `0x1f801802` (write, bank 1): `HINTMSK`
- L183: `0x1f801803` (write, bank 1): `HCLRCTL`
- L202: Caution - Unstable IRQ Flag polling
- L227: `0x1f801802` (write, bank 2): `ATV0` (L->L volume)
- L228: `0x1f801803` (write, bank 2): `ATV1` (L->R volume)
- L229: `0x1f801801` (write, bank 3): `ATV2` (R->R volume)
- L230: `0x1f801802` (write, bank 3): `ATV3` (R->L volume)
- L249: `0x1f801803` (write, bank 3): `ADPCTL`
- L257: `0x1f801801` (write, bank 1): `WRDATA`
- L265: `0x1f801801` (write, bank 2): `CI`
- L280: BUSYSTS flag
- L314: Misc
- L322: To init the CD
- L333: Seek-Busy Phase
- L348: Sound Map Flowchart
- L376: CDROM Controller Command Summary
- L377: Command Summary
- L435: sub\_function numbers (for command 19h)
- L492: Unsupported GetQ,VCD,SecretUnlock (command 1Dh,1Fh,5xh)
- L500: CDROM - Control Commands
- L501: Sync - Command 00h --\> INTx(stat+1,40h) (?)
- L506: Setfilter - Command 0Dh,file,channel --\> INT3(stat)
- L515: Setmode - Command 0Eh,mode --\> INT3(stat)
- L535: Init - Command 0Ah --\> INT3(stat) --\> INT2(stat)
- L542: Reset - Command 1Ch,(...) --\> INT3(stat) --\> Delay(1/8 seconds)
- L556: MotorOn - Command 07h --\> INT3(stat) --\> INT2(stat)
- L572: Stop - Command 08h --\> INT3(stat) --\> INT2(stat)
- L580: Pause - Command 09h --\> INT3(stat) --\> INT2(stat)
- L590: Data/ADPCM Sector Filtering/Delivery
- L616: CDROM - Seek Commands
- L617: Setloc - Command 02h,amm,ass,asect --\> INT3(stat)
- L630: SeekL - Command 15h --\> INT3(stat) --\> INT2(stat)
- L641: SeekP - Command 16h --\> INT3(stat) --\> INT2(stat)
- L653: SetSession - Command 12h,session --\> INT3(stat) --\> INT2(stat)
- L685: CDROM - Read Commands
- L686: ReadN - Command 06h --\> INT3(stat) --\> INT1(stat) --\> datablock
- L749: ReadS - Command 1Bh --\> INT3(stat) --\> INT1(stat) --\> datablock
- L754: ReadN/ReadS
- L758: CDROM Incoming Data / Buffer Overrun Timings
- L786: ReadTOC - Command 1Eh --\> INT3(stat) --\> INT2(stat)
- L799: Setloc, Read, Pause
- L818: CDROM - Status Commands
- L819: Status code (stat)
- L862: Stat Seek/Play/Read bits
- L869: Nop - Command 01h --\> INT3(stat)
- L878: Getparam - Command 0Fh --\> INT3(stat,mode,null,file,channel)
- L882: GetlocL - Command 10h --\> INT3(amm,ass,asect,mode,file,channel,sm,ci)
- L903: GetlocP - Command 11h - INT3(track,index,mm,ss,sect,amm,ass,asect)
- L920: GetTN - Command 13h --\> INT3(stat,first,last) ;BCD
- L926: GetTD - Command 14h,track --\> INT3(stat,mm,ss) ;BCD
- L936: GetQ - Command 1Dh,adr,point --\> INT3(stat) --\> INT2(10bytesSubQ,peak\_lo)
- L969: GetID - Command 1Ah --\> INT3(stat) --\> INT2/5 (stat,flags,type,atip,"SCEx")
- L1014: CDROM - CD Audio Commands
- L1018: Mute - Command 0Bh --\> INT3(stat)
- L1025: Demute - Command 0Ch --\> INT3(stat)
- L1031: Play - Command 03h (,track) --\> INT3(stat) --\> optional INT1(report bytes)
- L1052: Forward - Command 04h --\> INT3(stat) --\> optional INT1(report bytes)
- L1053: Backward - Command 05h --\> INT3(stat) --\> optional INT1(report bytes)
- L1068: Setmode bits used for Play command
- L1077: Report --\> INT1(stat,track,index,mm/amm,ss+80h/ass,sect/asect,peaklo,peakhi)
- L1097: AutoPause --\> INT4(stat)
- L1118: Playing XA-ADPCM Sectors (compressed audio data)
- L1139: CDROM - Test Commands
- L1148: CDROM - Test Commands - Version, Switches, Region, Chipset, SCEx
- L1149: 19h,20h --\> INT3(yy,mm,dd,ver)
- L1171: 19h,21h --\> INT3(flags)
- L1180: 19h,22h --\> INT3("for Europe")
- L1197: 19h,23h --\> INT3("CXD2940Q/CXD1817Q/CXD2545Q/CXD1782BR") ;Servo Amplifier
- L1198: 19h,24h --\> INT3("CXD2940Q/CXD1817Q/CXD2545Q/CXD2510Q")  ;Signal Processor
- L1199: 19h,25h --\> INT3("CXD2940Q/CXD1817Q/CXD1815Q/CXD1199BQ") ;Decoder/FIFO
- L1211: 19h,04h --\> INT3(stat) ;Read SCEx string (and force motor on)
- L1225: 19h,05h --\> INT3(total,success)  ;Get SCEx Counters
- L1238: CDROM - Test Commands - Test Drive Mechanics
- L1241: 19h,50h,msb[,mid,[lsb[,xlo]]] --\> INT3(stat)
- L1253: 19h,51h,msb[,mid,[lsb]] --\> INT3(stat,hi,lo)  ;BIOS vC2/vC3 only
- L1265: 19h,51h,39h,xxh --\> INT3(stat,hi,lo)  ;BIOS vC2/vC3 only
- L1271: 19h,03h --\> INT3(stat) ;force motor off
- L1274: 19h,17h --\> INT3(stat) ;force motor on, clockwise, super-fast
- L1275: 19h,01h --\> INT3(stat) ;force motor on, anti-clockwise, super-fast
- L1276: 19h,02h --\> INT3(stat) ;force motor on, anti-clockwise, super-fast
- L1277: 19h,10h --\> INT3(stat) ;force motor on, anti-clockwise, super-fast
- L1278: 19h,18h --\> INT3(stat) ;force motor on, anti-clockwise, super-fast
- L1285: 19h,00h --\> INT3(stat) ;force motor on, clockwise (even if shell open)
- L1296: 19h,11h --\> INT3(stat) ;Move Lens Up (leave parking position)
- L1297: 19h,12h --\> INT3(stat) ;Move Lens Down (enter parking position)
- L1298: 19h,13h --\> INT3(stat) ;Move Lens Outwards (away from center of disk)
- L1299: 19h,14h --\> INT3(stat) ;Move Lens Inwards (towards center of disk)
- L1304: 19h,15h - if motor on: move head outwards + inwards + motor off
- L1312: 19h,16h --\> INT3(stat) ;Unknown / makes some noise if motor is on
- L1313: 19h,19h --\> INT3(stat) ;Unknown / no effect
- L1314: 19h,1Ah --\> INT3(stat) ;Unknown / makes some noise if motor is on
- L1318: 19h,06h,new --\> INT3(old) ;Adjust balance in RAM, and apply it via CX(30+n)
- L1319: 19h,07h,new --\> INT3(old) ;Adjust gain in RAM, and apply it via CX(38+n)
- L1320: 19h,08h,new --\> INT3(old) ;Adjust balance in RAM only
- L1329: CDROM - Test Commands - Prototype Debug Transmission
- L1330: Serial Debug Messages
- L1343: 19h,30h,index,dat1,dat2 --\> INT3(stat) ;Prototype/Debug stuff
- L1344: 19h,31h,dat1,dat2 --\> INT3(stat) ;Prototype/Debug stuff
- L1345: 19h,4xh,index --\> INT3(dat1,dat2) ;Prototype/Debug stuff
- L1354: INT5 Debug Messages
- L1362: CDROM - Test Commands - Read/Write Decoder RAM and I/O Ports
- L1366: 19h,71h,index --\> INT3(databyte) ;Read single register
- L1398: 19h,72h,index,databyte --\> INT3(stat) ;Write single register
- L1403: 19h,73h,index,len --\> INT3(databytes...) ;Read multiple registers (bugged)
- L1404: 19h,74h,index,len,databytes --\> INT3(stat) ;Write multiple registers (bugged)
- L1412: 19h,75h --\> INT3(remain.lo,remain.hi,addr.lo,addr.hi) ;Get Host Xfer Info
- L1426: 19h,76h,len\_lo,len\_hi,addr\_lo,addr\_hi --\> INT3(stat) ;Prepare SRAM Transfer
- L1432: CDROM - Test Commands - Read HC05 SUB-CPU RAM and I/O Ports
- L1433: 19h,60h,addr\_lo,addr\_hi --\> INT3(data) ;Read one byte from Drive RAM or I/O
- L1443: CDROM Controller I/O Area and RAM Memory Map
- L1569: DTL-H2000 Memory Map
- L1584: Writing to RAM
- L1596: Subchannel Q Notes
- L1605: CDROM - Secret Unlock Commands
- L1606: SecretUnlockPart1 - Command 50h --\> INT5(11h,40h)
- L1607: SecretUnlockPart2 - Command 51h,"Licensed by" --\> INT5(11h,40h)
- L1608: SecretUnlockPart3 - Command 52h,"Sony" --\> INT5(11h,40h)
- L1609: SecretUnlockPart4 - Command 53h,"Computer" --\> INT5(11h,40h)
- L1610: SecretUnlockPart5 - Command 54h,"Entertainment" --\> INT5(11h,40h)
- L1611: SecretUnlockPart6 - Command 55h,\<region\> --\> INT5(11h,40h)
- L1612: SecretUnlockPart7 - Command 56h --\> INT5(11h,40h)
- L1644: SecretLock - Command 57h --\> INT5(11h,40h)
- L1648: SecretCrash - Command 58h..5Fh --\> Crash
- L1655: CDROM - Video CD Commands
- L1666: VideoCdSio - Cmd 1Fh,01h,JoyL,JoyH,State,Task,0 --\> INT3(stat,req,mm,ss,ff,x)
- L1716: VideoCdSwitch - Cmd 1Fh,02h,flag,x,x,x,x --\> INT3(stat,0,0,x,x,x)
- L1722: Some findings on the SC430924 firmware...
- L1762: Note
- L1768: CDROM - Mainloop/Responses
- L1769: SUB-CPU Mainloop
- L1799: Responses
- L1814: First Response (INT3) (or INT5 if failed)
- L1832: Second Responses (INT2) (or INT5 if failed)
- L1858: Data/Report Responses (INT1)
- L1869: CDROM - Response Timings
- L1877: First Response
- L1896: Second Response
- L1923: INT1 Rate
- L1936: CDROM - Response/Data Queueing
- L1939: Sector Buffer
- L1958: Sector Buffer Test Cases
- L2001: Sector Buffer VS GetlocL Response Tests
- L2047: Sector Buffer VS Pause Response Tests
- L2089: Double Commands (Getloc then Pause)
- L2134: Double Commands (Pause then Getloc)
