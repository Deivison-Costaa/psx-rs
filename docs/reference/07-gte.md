<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/geometrytransformationenginegte.md
...
- L1: Geometry Transformation Engine (GTE)
- L14: GTE Overview
- L15: GTE Operation
- L29: GTE Load Delay Slots
- L45: GTE Command Encoding (COP2 imm25 opcodes)
- L65: GTE Data Register Summary (cop2r0-31)
- L84: GTE Control Register Summary (cop2r32-63)
- L102: GTE Registers
- L105: Matrix Registers
- L121: Translation Vector (TR) (Input, R/W?)
- L130: Background Color (BK) (Input?, R/W?)
- L138: Far Color (FC) (Input?) (R/W?)
- L146: Screen Offset and Distance (Input, R/W?)
- L164: Average Z Registers (ZSF3/ZSF4=Input, R/W?) (OTZ=Result, R)
- L172: Screen XYZ Coordinate FIFOs
- L191: 16bit Vectors (R/W)
- L202: Color Register and Color FIFO
- L214: Interpolation Factor
- L220: MAC0 - Sum of Products Value 0 (R/W)
- L225: MAC1..MAC3 - Sum of Products Values 1-3 (R/W)
- L232: cop2r28 - IRGB - Color conversion Input (R/W)
- L245: cop2r29 - ORGB - Color conversion Output (R)
- L259: cop2r30 - LZCS - Count Leading Bits Source data (R/W)
- L260: cop2r31 - LZCR - Count Leading Bits Result (R)
- L264: cop2r63 (cnt31) - FLAG - Returns any calculation errors.
- L269: GTE Saturation
- L277: cop2r63 (cnt31) - FLAG - Returns any calculation errors.
- L314: GTE Opcode Summary
- L315: GTE Command Summary (sorted by Real Opcode bits) (bit0-5)
- L355: GTE Command Summary (sorted by Fake Opcode bits) (bit20-24)
- L399: Additional Functions
- L408: GTE Coordinate Calculation Commands
- L409: COP2 0180001h - 15 Cycles - RTPS - Perspective Transformation (single)
- L410: COP2 0280030h - 23 Cycles - RTPT - Perspective Transformation (triple)
- L441: COP2 1400006h - 8 Cycles - NCLIP - Normal clipping
- L451: COP2 158002Dh - 5 Cycles - AVSZ3 - Average of three Z values (for Triangles)
- L452: COP2 168002Eh - 6 Cycles - AVSZ4 - Average of four Z values (for Quads)
- L468: GTE General Purpose Calculation Commands
- L469: COP2 0400012h - 8 Cycles - MVMVA(sf,mx,v,cv,lm)
- L494: COP2 0A00428h+sf\*80000h - 5 Cycles - SQR(sf) - Square vector
- L502: COP2 170000Ch+sf\*80000h - 6 Cycles - OP(sf,lm) - Cross product of 2 vectors
- L514: LZCS/LZCR registers - ? Cycles - Count-Leading-Zeroes/Leading-Ones
- L519: GTE Color Calculation Commands
- L520: COP2 0C8041Eh - 14 Cycles - NCS - Normal color (single)
- L521: COP2 0D80420h - 30 Cycles - NCT - Normal color (triple)
- L522: COP2 108041Bh - 17 Cycles - NCCS - Normal Color Color (single vector)
- L523: COP2 118043Fh - 39 Cycles - NCCT - Normal Color Color (triple vector)
- L524: COP2 0E80413h - 19 Cycles - NCDS - Normal color depth cue (single vector)
- L525: COP2 0F80416h - 44 Cycles - NCDT - Normal color depth cue (triple vectors)
- L538: COP2 138041Ch - 11 Cycles - CC(lm=1) - Color Color
- L539: COP2 1280414h - 13 Cycles - CDP(...) - Color Depth Que
- L550: COP2 0680029h - 8 Cycles - DCPL - Depth Cue Color light
- L551: COP2 0780010h - 8 Cycles - DPCS - Depth Cueing (single)
- L552: COP2 0F8002Ah - 17 Cycles - DPCT - Depth Cueing (triple)
- L553: COP2 0980011h - 8 Cycles - INTPL - Interpolation of a vector and far color
- L569: COP2 190003Dh - 5 Cycles - GPF(sf,lm) - General purpose Interpolation
- L570: COP2 1A0003Eh - 5 Cycles - GPL(sf,lm) - General Interpolation with base
- L580: Details on "MAC+(FC-MAC)\*IR0"
- L589: Details on "(LLM\*V0) SAR (sf\*12)" and "(BK\*1000h + LCM\*IR) SAR (sf\*12)"
- L594: Notes
- L611: GTE Division Inaccuracy
- L612: GTE Division Inaccuracy (for RTPS/RTPT commands)
