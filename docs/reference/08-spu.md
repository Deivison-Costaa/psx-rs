<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/soundprocessingunitspu.md
...
- L1: Sound Processing Unit (SPU)
- L18: SPU Overview
- L19: SPU I/O Port Summary
- L31: SPU Memory layout (512Kbyte RAM)
- L46: Voices
- L52: Voice Capabilities
- L59: Additional Sound Inputs
- L64: Mono/Stereo Audio Output
- L70: Unstable and Delayed I/O
- L77: SPU Bus-Width
- L85: SPU ADPCM Samples
- L91: 1F801C06h+N\*10h - Voice 0..23 ADPCM Start Address (R/W)
- L100: 1F801C0Eh+N\*10h - Voice 0..23 ADPCM Repeat Address (R/W)
- L116: Sample Data (SPU-ADPCM)
- L128: Flag Bits (in 2nd byte of ADPCM Header)
- L143: Looped and One-shot Samples
- L151: SPU-ADPCM vs XA-ADPCM
- L163: SPU ADPCM Pitch
- L164: 1F801C04h+N\*10h - Voice 0..23 ADPCM Sample Rate (R/W) (VxPitch)
- L172: 1F801D90h - Voice 0..23 Pitch Modulation Enable Flags (PMON)
- L187: Pitch Counter
- L203: Maximum Sound Frequency
- L215: 4-Point Gaussian Interpolation
- L301: Waveform Examples
- L329: SPU Volume and ADSR Generator
- L330: 1F801C08h+N\*10h - Voice 0..23 Attack/Decay/Sustain/Release (ADSR) (32bit)
- L357: 1F801D80h - Mainvolume left
- L358: 1F801D82h - Mainvolume right
- L359: 1F801C00h+N\*10h - Voice 0..23 Volume Left
- L360: 1F801C02h+N\*10h - Voice 0..23 Volume Right
- L389: 1F801DB0h - CD Audio Input Volume (for normal CD-DA, and compressed XA-ADPCM)
- L390: 1F801DB4h - External Audio Input Volume
- L398: Envelope Operation depending on Shift/Step/Mode/Direction
- L464: 1F801C0Ch+N\*10h - Voice 0..23 Current ADSR volume (R/W)
- L475: 1F801DB8h - Current Main Volume Left/Right
- L476: 1F801E00h+voice\*04h - Voice 0..23 Current Volume Left/Right
- L484: Note
- L489: SPU Voice Flags
- L490: 1F801D88h - Voice 0..23 Key ON (Start Attack/Decay/Sustain) (KON) (W)
- L497: 1F801D8Ch - Voice 0..23 Key OFF (Start Release) (KOFF) (W)
- L506: 1F801D9Ch - Voice 0..23 ON/OFF (status) (ENDX) (R)
- L514: R/W
- L524: SPU Noise Generator
- L525: 1F801D94h - Voice 0..23 Noise mode enable (NON)
- L531: SPU Noise Generator
- L549: SPU Control and Status Register
- L550: 1F801DAAh - SPU Control Register (SPUCNT)
- L569: 1F801DAEh - SPU Status Register  (SPUSTAT) (R)
- L592: SPU Memory Access
- L593: 1F801DA6h - Sound RAM Data Transfer Address
- L603: 1F801DA8h - Sound RAM Data Transfer Fifo
- L609: 1F801DACh - Sound RAM Data Transfer Control (should be 0004h)
- L632: SPU RAM Manual Write
- L646: SPU RAM DMA-Write
- L654: SPU RAM Manual-Read
- L657: SPU RAM DMA-Read (stable reading, with [1F801014h].bit24-27 = nonzero)
- L666: SPU RAM DMA-Read (unstable reading, with [1F801014h].bit24-27 = zero)
- L718: SPU Interrupt
- L719: 1F801DA4h - Sound RAM IRQ Address (IRQ9)
- L725: Voice Interrupt
- L738: Capture Interrupt
- L748: Reverb Interrupt
- L753: Data Transfers
- L756: Note
- L768: SPU Reverb Registers
- L769: Reverb Volume and Address Registers (R/W)
- L815: 1F801D98h - Voice 0..23 Reverb mode aka Echo On (EON) (R/W)
- L825: Reverb Bits in SPUCNT Register (R/W)
- L838: SPU Reverb Formula
- L839: Reverb Formula
- L867: Notes
- L882: Reverb Disable
- L889: Bug
- L897: Speed of Sound
- L902: Reverb Buffer Resampling
- L914: SPU Reverb Examples
- L915: Reverb Examples
- L930: Room (size=26C0h bytes)
- L938: Studio Small (size=1F40h bytes)
- L946: Studio Medium (size=4840h bytes)
- L954: Studio Large (size=6FE0h bytes)
- L962: Hall (size=ADE0h bytes)
- L970: Half Echo (size=3C00h bytes)
- L978: Space Echo (size=F6C0h bytes)
- L986: Chaos Echo (almost infinite) (size=18040h bytes)
- L994: Delay (one-shot echo) (size=18040h bytes)
- L1002: Reverb off (size=10h dummy bytes)
- L1018: SPU Unknown Registers
- L1019: 1F801DA0h - Some kind of a read-only status register.. or just garbage..?
- L1027: 1F801DBCh - 4 bytes - Unknown? (R/W)
- L1036: 1F801E60h - 32 bytes - Unknown? (R/W)
- L1054: SPU Internal State Machine from SPU RAM Timing
- L1055: Introduction
- L1067: First look at the data from logic analyzer.
- L1077: Sequence of work
- L1100: What we can guess from those information.
- L1106: Reverb Computation Order
- L1126: Voices
- L1133: Notes
