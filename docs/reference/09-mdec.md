<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/macroblockdecodermdec.md
...
- L1: Macroblock Decoder (MDEC)
- L12: MDEC I/O Ports
- L13: 1F801820h - MDEC0 - MDEC Command/Parameter Register (W)
- L21: 1F801820h.Read - MDEC Data/Response Register (R)
- L31: 1F801824h - MDEC1 - MDEC Status Register (R)
- L52: 1F801824h - MDEC1 - MDEC Control/Reset Register (W)
- L65: DMA
- L79: MDEC Commands
- L80: MDEC(1) - Decode Macroblock(s)
- L92: MDEC(2) - Set Quant Table(s)
- L102: MDEC(3) - Set Scale Table
- L111: MDEC(0) - No function
- L117: MDEC(4..7) - Invalid
- L122: MDEC Decompression
- L123: decode\_colored\_macroblock ;MDEC(1) command (at 15bpp or 24bpp depth)
- L133: decode\_monochrome\_macroblock ;MDEC(1) command (at 4bpp or 8bpp depth)
- L138: rl\_decode\_block(blk,src,qt)
- L160: fast\_idct\_core(blk) ;fast "idct\_core" version
- L192: real\_idct\_core(blk) ;low level "idct\_core" version
- L220: yuv\_to\_rgb(xx,yy)
- L238: y\_to\_mono
- L249: set\_iqtab  ;MDEC(2) command
- L257: iqtab\_core(iq,src)  ;src = 64 unsigned paramter bytes
- L265: scalefactor[0..7] = cos((0..7)\*90'/8)  ;for [1..7]: multiplied by sqrt(2)
- L271: zigzag[0..63] =
- L283: scalezag[0..63] (precalulated factors, for "fast\_idct\_core")
- L292: zagzig[0..63] (reversed zigzag table)
- L297: set\_scale\_table:  ;MDEC(3) command
- L326: MDEC Data Format
- L327: Colored Macroblocks (16x16 pixels) (in 15bpp or 24bpp depth mode)
- L346: Monochrome Macroblocks (8x8 pixel) (in 4bpp or 8bpp depth mode)
- L361: Blocks (8x8 pixels)
- L369: .STR Files
- L372: MDEC vs JPEG
- L386: Run-Length compressed Blocks
- L394: DCT (1st value)
- L402: RLE (Run length data, for 2nd through 64th value)
- L409: EOB (End Of Block)
- L419: Dummy halfwords
