<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/kernelbios.md
...
- L54: BIOS Memory
- L68: BIOS Memory Map
- L69: BIOS ROM Map (512Kbytes)
- L77: BIOS ROM Header/Footer
- L85: BIOS RAM Map (1st 64Kbytes of RAM) (fixed addresses mainly in 1st 500h bytes)
- L111: User Memory (not used by Kernel)
- L118: Table of Tables (see BIOS Control Blocks for details)
- L137: Garbage Area at Address 00000000h
- L160: BIOS Function Summary
- L161: Parameters, Registers, Stack
- L176: A-Functions (Call 00A0h with function number in R9 Register)
- L365: B-Functions (Call 00B0h with function number in R9 Register)
- L468: C-Functions (Call 00C0h with function number in R9 Register)
- L504: SYS-Functions (Syscall opcode with function number in R4 aka A0 Register)
- L514: BREAK-Functions (Break opcode with function number in opcode's immediate)
- L542: BIOS File Functions
- L543: A(00h) or B(32h) - open(filename, accessmode) - Opens a file for IO
- L564: A(01h) or B(33h) - lseek(fd, offset, seektype) - Move the file pointer
- L574: A(02h) or B(34h) - read(fd, dst, length) - Read data from an open file
- L582: A(03h) or B(35h) - write(fd, src, length) - Write data to an open file
- L589: A(04h) or B(36h) - close(fd) - Close an open file
- L592: A(08h) or B(3Ah) - getc(fd) - read one byte from file
- L600: A(09h) or B(3Bh) - putc(char,fd) - write one byte to file
- L607: B(40h) - cd(name) - Change the current directory on target device
- L621: B(42h) - firstfile2(filename,direntry) - Find first file to match the name
- L658: B(43h) - nextfile(direntry) - Searches for the next file to match the name
- L662: B(44h) - rename(old\_filename, new\_filename)
- L665: B(45h) - erase(filename) - Delete a file on target device
- L668: B(46h) - undelete(filename)
- L671: B(41h) - format(devicename)
- L675: B(54h) - \_get\_errno()
- L683: B(55h) - \_get\_error(fd)
- L689: A(05h) or B(37h) - ioctl(fd,cmd,arg)
- L692: A(07h) or B(39h) - isatty(fd)
- L696: B(59h) - testdevice(devicename)
- L702: File Error Numbers for B(54h) and B(55h)
- L720: BIOS File Execute and Flush Cache
- L721: A(41h) - LoadTest(filename, headerbuf)
- L725: A(42h) - Load(filename, headerbuf)
- L734: A(43h) - Exec(headerbuf, param1, param2)
- L745: A(51h) - LoadExec(filename, stackbase, stackoffset)
- L781: A(9Ch) - SetConf(num\_EvCB, num\_TCB, stacktop)
- L792: A(9Dh) - GetConf(num\_EvCB\_dst, num\_TCB\_dst, stacktop\_dst)
- L797: A(44h) - FlushCache()
- L830: Executable Memory Allocation
- L839: Note
- L845: BIOS CDROM Functions
- L846: General File Functions
- L856: Absent CD-Audio Support
- L861: Asynchronous CDROM Access
- L869: A(A4h) - CdGetLbn(filename)
- L876: A(A5h) - CdReadSector(count,sector,buffer)
- L882: A(A6h) - CdGetStatus()
- L888: A(78h) - CdAsyncSeekL(src)
- L894: A(7Ch) - CdAsyncGetStatus(dst)
- L904: A(7Eh) - CdAsyncReadSector(count,dst,mode)
- L916: A(81h) - CdAsyncSetMode(mode)
- L920: A(94h) - CdromGetInt5errCode(dst1,dst2)
- L925: A(54h) or A(71h) - \_96\_init()
- L926: A(56h) or A(72h) - \_96\_remove()  ;does NOT work due to SysDeqIntRP bug
- L927: A(90h) - CdromIoIrqFunc1()
- L928: A(91h) - CdromDmaIrqFunc1()
- L929: A(92h) - CdromIoIrqFunc2()
- L930: A(93h) - CdromDmaIrqFunc2()
- L931: A(95h) - CdInitSubFunc()  ;subfunction for _96_init()
- L932: A(9Eh) - SetCdromIrqAutoAbort(type,flag)
- L933: A(A2h) - EnqueueCdIntr()  ;with prio=0 (fixed)
- L934: A(A3h) - DequeueCdIntr()  ;does NOT work due to SysDeqIntRP bug
- L939: BIOS Memory Card Functions
- L940: General File Functions
- L947: File Header, Filesize, and Sector Alignment
- L961: Poor Memcard Performance
- L980: Asynchronous Access
- L1004: Multitap Support (and Multitap Problems)
- L1019: B(4Ah) - InitCARD2(pad\_enable)  ;uses/destroys k0/k1 !!!
- L1020: B(4Bh) - StartCARD2()
- L1021: B(4Ch) - StopCARD2()
- L1022: A(55h) or A(70h) - \_bu\_init()
- L1028: A(ABh) - \_card\_info(port)
- L1029: B(4Dh) - \_card\_info\_subfunc(port)  ;subfunction for "\_card\_info"
- L1035: A(AFh) - card\_write\_test(port)  ;not supported by old CEX-1000 version
- L1040: B(50h) - \_new\_card()
- L1047: B(4Eh) - \_card\_write(port,sector,src)
- L1048: B(4Fh) - \_card\_read(port,sector,dst)
- L1063: B(5Ch) - \_card\_status(slot)
- L1064: B(5Dh) - \_card\_wait(slot)
- L1077: A(A7h) - bufs\_cb\_0()
- L1078: A(A8h) - bufs\_cb\_1()
- L1079: A(A9h) - bufs\_cb\_2()
- L1080: A(AAh) - bufs\_cb\_3()
- L1081: A(AEh) - bufs\_cb\_4()
- L1085: B(58h) - \_card\_chan()
- L1089: A(ACh) - \_card\_load(port)
- L1095: A(ADh) - \_card\_auto(flag)
- L1105: C(1Ah) - set\_card\_find\_mode(mode)
- L1106: C(1Dh) - get\_card\_find\_mode()
- L1114: BIOS Interrupt/Exception Handling
- L1118: Inefficiency
- L1125: Unstable IRQ Handling
- L1140: B(18h) - ResetEntryInt()
- L1147: B(19h) - HookEntryInt(addr)
- L1164: Priority Chains
- L1184: C(02h) - SysEnqIntRP(priority,struc)  ;bugged, use with care
- L1205: C(03h) - SysDeqIntRP(priority,struc)  ;bugged, use with care
- L1215: SYS(01h) - EnterCriticalSection()  ;syscall with r4=01h
- L1220: SYS(02h) - ExitCriticalSection()   ;syscall with r4=02h
- L1225: C(0Dh) - SetIrqAutoAck(irq,flag)
- L1235: C(06h) - ExceptionHandler()
- L1252: B(17h) - ReturnFromException()
- L1259: C(00h) - EnqueueTimerAndVblankIrqs(priority) ;used with prio=1
- L1260: C(01h) - EnqueueSyscallHandler(priority) ;used with prio=0
- L1261: C(0Ch) - InitDefInt(priority) ;used with prio=3
- L1264: No Nested Exceptions
- L1276: BIOS Event Functions
- L1277: B(08h) - OpenEvent(class, spec, mode, func)
- L1296: B(09h) - CloseEvent(event) - releases event from the event table
- L1299: B(0Ch) - EnableEvent(event) - Turns on event handling for specified event
- L1302: B(0Dh) - DisableEvent(event) - Turns off event handling for specified event
- L1305: B(0Ah) - WaitEvent(event)
- L1317: B(0Bh) - TestEvent(event)
- L1322: B(07h) - DeliverEvent(class, spec)
- L1328: B(20h) - UnDeliverEvent(class, spec)
- L1333: C(04h) - get\_free\_EvCB\_slot()
- L1336: Event Classes
- L1384: Event Specs
- L1407: Event modes
- L1415: BIOS Event Summary
- L1423: CDROM Events
- L1434: Memory Card - Higher Level File/Device Events
- L1443: Memory Card - Lower Level Hardware I/O Events
- L1453: Timer/Vblank Events
- L1461: Default IRQ Handler Events (very unstable, don't use)
- L1476: Unresolved Exception Events
- L1484: BIOS Thread Functions
- L1485: B(0Eh) - OpenTh(reg\_PC,reg\_SP\_FP,reg\_GP)
- L1499: BUG - Unitialized SR Register
- L1509: B(0Fh) - CloseTh(handle)
- L1518: B(10h) - ChangeTh(handle)
- L1533: C(05h) - get\_free\_TCB\_slot()
- L1537: SYS(03h) ChangeThreadSubFunction(addr) ;syscall with r4=03h, r5=addr
- L1545: BIOS Timer Functions
- L1546: Timers (aka Root Counters)
- L1551: Vblank
- L1564: B(02h) - init\_timer(t,reload,flags)
- L1575: B(03h) - get\_timer(t)
- L1579: B(04h) - enable\_timer\_irq(t)
- L1580: B(05h) - disable\_timer\_irq(t)
- L1586: B(06h) - restart\_timer(t)
- L1590: C(0Ah) - ChangeClearRCnt(t,flag) ;root counter (aka timer)
- L1598: BIOS Joypad Functions
- L1599: Pad Input
- L1608: B(12h) - InitPAD2(buf1, siz1, buf2, siz2)
- L1631: B(13h) - StartPAD2()
- L1635: B(14h) - StopPAD2()
- L1639: B(15h) - PAD\_init2(type, button\_dest, unused, unused)
- L1655: B(16h) - PAD\_dr()
- L1677: BIOS GPU Functions
- L1678: A(48h) - SendGP1Command(gp1cmd)
- L1681: A(49h) - GPU\_cw(gp0cmd)      ;send GP0 command word
- L1685: A(4Ah) - GPU\_cwp(src,num) ;send GP0 command word and parameter words
- L1690: A(4Bh) - send\_gpu\_linked\_list(src)
- L1697: A(4Ch) - gpu\_abort\_dma()
- L1702: A(4Dh) - GetGPUStatus()
- L1705: A(46h) - GPU\_dw(Xdst,Ydst,Xsiz,Ysiz,src)
- L1717: A(47h) - gpu\_send\_dma(Xdst,Ydst,Xsiz,Ysiz,src)
- L1725: A(4Eh) - gpu\_sync()
- L1736: BIOS Memory Allocation
- L1737: A(33h) - malloc(size)
- L1748: A(34h) - free(buf)
- L1754: A(37h) - calloc(sizx, sizy)     ;SLOW!
- L1759: A(38h) - realloc(old\_buf, new\_size)   ;SLOW!
- L1770: A(39h) - InitHeap(addr, size)
- L1780: B(00h) - alloc\_kernel\_memory(size)
- L1781: B(01h) - free\_kernel\_memory(buf)
- L1791: Scratchpad Note
- L1796: A(9Fh) - SetMem(megabytes)
- L1808: BIOS Memory Fill/Copy/Compare (SLOW)
- L1819: A(2Ah) - memcpy(dst, src, len)
- L1824: A(2Bh) - memset(dst, fillbyte, len)
- L1829: A(2Ch) - memmove(dst, src, len) - bugged
- L1836: A(2Dh) - memcmp(src1, src2, len) - bugged
- L1848: A(2Eh) - memchr(src, scanbyte, len)
- L1853: A(27h) - bcopy(src, dst, len)
- L1858: A(28h) - bzero(dst, len)
- L1861: A(29h) - bcmp(ptr1, ptr2, len) - bugged
- L1866: BIOS String Functions
- L1867: A(15h) - strcat(dst, src)
- L1873: A(16h) - strncat(dst, src, maxlen)
- L1880: A(17h) - strcmp(str1, str2)
- L1887: A(18h) - strncmp(str1, str2, maxlen)
- L1892: A(19h) - strcpy(dst, src)
- L1897: A(1Ah) - strncpy(dst, src, maxlen)
- L1903: A(1Bh) - strlen(src)
- L1907: A(1Ch) - index(src, char)
- L1908: A(1Dh) - rindex(src, char)
- L1909: A(1Eh) - strchr(src, char)  ;exactly the same as "index"
- L1910: A(1Fh) - strrchr(src, char) ;exactly the same as "rindex"
- L1917: A(20h) - strpbrk(src, list)
- L1925: A(21h) - strspn(src, list)
- L1926: A(22h) - strcspn(src, list)
- L1944: A(23h) - strtok(src, list) ;first call
- L1945: A(23h) - strtok(0, list) ;further call(s)
- L1970: A(24h) - strstr(str, substr) - buggy
- L1980: BIOS Number/String/Character Conversion
- L1981: A(0Eh) - abs(val)
- L1982: A(0Fh) - labs(val)  ;exactly same as "abs"
- L1985: A(0Ah) - todigit(char)
- L1990: A(25h) - toupper(char)
- L1991: A(26h) - tolower(char)
- L1997: A(0Dh) - strtol(src, src\_end, base)
- L2026: A(0Ch) - strtoul(src, src\_end, base)
- L2030: A(10h) - atoi(src)
- L2031: A(11h) - atol(src)  ;exactly same as "atoi" (but slightly slower)
- L2039: A(12h) - atob(src, num\_dst)
- L2043: A(0Bh) - atof(src) ;USES (ABSENT) COP1 FPU !!!
- L2044: A(32h) - strtod(src, src\_end) ;USES (ABSENT) COP1 FPU !!!
- L2052: Note
- L2059: BIOS Misc Functions
- L2060: A(2Fh) - rand()
- L2064: A(30h) - srand(seed)
- L2067: A(B4h) - GetSystemInfo(index)  ;not supported by old CEX-1000 version
- L2088: B(56h) - GetC0Table()
- L2089: B(57h) - GetB0Table()
- L2097: A(31h) - qsort(base, nel, width, callback)
- L2111: A(35h) - lsearch(key, base, nel, width, callback)
- L2112: A(36h) - bsearch(key, base, nel, width, callback)
- L2122: C(19h) - \_ioabort(txt1,txt2)
- L2127: A(B2h) - _ioabort\_raw(param)  ;not supported by old CEX-1000 version
- L2132: A(13h) - setjmp(buf)
- L2151: A(14h) - longjmp(buf, param)
- L2161: A(53h) - set\_ioabort\_handler(src)  ;PS2 only  ;PSX: SystemError
- L2167: A(06h) or B(38h) - exit(exitcode)
- L2171: A(A0h) - \_boot()
- L2180: A(B5h..BFh) B(11h,24h..29h,2Ch..31h,5Eh..FFh) C(1Eh..7Fh) - N/A - Jump 0
- L2186: A(57h..5Ah,73h..77h,79h..7Bh,7Dh,7Fh..80h,82h..8Fh,B0h..B1h,B3h), and
- L2187: C(0Eh..11h,14h) - N/A - Returns 0
- L2191: SYS(00h) - NoFunction()
- L2195: SYS(04h..FFFFFFFFh) - calls DeliverEvent(F0000010h,4000h)
- L2200: A(3Ah) - \_exit(exitcode)
- L2201: A(40h) - SystemErrorUnresolvedException()
- L2202: A(A1h) - SystemError(type,errorcode) ;type "B"=Boot,"D"=Disk
- L2207: A(4Fh,50h,52h,53h,9Ah,9Bh) B(1Ah..1Fh,21h..23h,2Ah,2Bh,52h,5Ah) C(0Bh) - N/A
- L2211: BRK(1C00h) - Division by zero (commonly checked/invoked by software)
- L2212: BRK(1800h) - Division overflow (-80000000h/-1, sometimes checked by software)
- L2221: BIOS Internal Boot Functions
- L2222: A(45h) - init\_a0\_b0\_c0\_vectors
- L2226: C(07h) - InstallExceptionHandlers()  ;destroys/uses k0/k1
- L2231: C(08h) - SysInitMemory(addr,size)
- L2236: C(09h) - SysInitKernelVariables()
- L2242: C(12h) - InstallDevices(ttyflag)
- L2248: C(1Ch) - AdjustA0Table()
- L2256: BIOS More Internal Functions
- L2259: Internal Device Stuff
- L2295: Device Names
- L2310: BIOS PC File Server
- L2311: DTL-H2000
- L2315: Caetla Blurb
- L2325: BRK(101h) - PCInit() - Inits the fileserver
- L2328: BRK(102h) - PCCreat(filename, fileattributes) - Creates a new file on PC
- L2344: BRK(103h) - PCOpen(filename, accessmode) - Opens a file on the PC
- L2350: BRK(104h) - PCClose(filehandle) - Closes a file on the PC
- L2356: BRK(105h) - PCRead(filehandle, length, memory\_destination\_address)
- L2367: BRK(106h) - PCWrite(filehandle, length, memory\_source\_address)
- L2373: BRK(107h) - PClSeek(filehandle, file\_offset, seekmode) - Change Filepos
- L2382: BIOS TTY Console (std\_io)
- L2383: A(3Fh) - Printf(txt,param1,param2,etc.) - Print string to console
- L2422: A(3Eh) or B(3Fh) - puts(src) - Write string to TTY
- L2431: A(3Dh) or B(3Eh) - gets(dst) - Read string from TTY (keyboard input)
- L2450: A(3Bh) or B(3Ch) - getchar() - Read character from TTY
- L2456: A(3Ch) or B(3Dh) - putchar(char) - Write character to TTY
- L2464: C(13h) - FlushStdInOutPut()
- L2467: C(1Bh) - KernelRedirect(ttyflag)  ;PS2: ttyflag=1 causes SystemError
- L2477: Activating std\_io
- L2502: B(49h) - PrintInstalledDevices()
- L2506: Note
- L2513: BIOS Character Sets
- L2514: B(51h) - Krom2RawAdd(shiftjis\_code)
- L2521: B(53h) - Krom2Offset(shiftjis\_code)
- L2528: Character Sets in ROM (112Kbytes)
- L2562: BIOS Control Blocks
- L2563: Exception Control Blocks (ExCB) (4 blocks of 8 bytes each)
- L2569: Event Control Blocks (EvCB) (usually 16 blocks of 1Ch bytes each)
- L2579: Thread Control Blocks (TCB) (usually 4 blocks of 0C0h bytes each)
- L2591: Process Control Block (1 block of 4 bytes)
- L2597: File Control Blocks (FCB) (16 blocks of 2Ch bytes each)
- L2613: Device Control Blocks (DCB) (10 blocks of 50h bytes each)
- L2639: BIOS Versions
- L2640: Kernel Versions
- L2667: Bootmenu/Intro Versions
- L2718: Character Set Versions
- L2733: BIOS Patches
- L2744: Patches and Anti-Patch-Patches
- L2753: Compatibility
- L2760: patch\_missing\_cop0r13\_in\_exception\_handler:
- L2879: early\_card\_irq\_patch:
- L2957: patch\_uninstall\_early\_card\_irq\_handler:
- L3002: patch\_card\_specific\_delay:
- L3052: patch\_card\_info\_step4:
- L3072: patch\_pad\_error\_handling\_and\_get\_pad\_enable\_functions:
- L3134: patch\_optional\_pad\_output:
- L3192: patch\_no\_pad\_card\_auto\_ack:
- L3235: patch\_install\_lightgun\_irq\_handler:
- L3284: set\_conf\_without\_realloc:
- L3302: Cheat Devices
- L3323: Note
