<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/cdromformat.md
...
- L1: CDROM Format
- L2: General CDROM Disk Format
- L15: Playstation CDROM Protection
- L24: CDROM Disk Format
- L25: Overview
- L33: CDROM Filesystem (ISO 9660 aka ECMA-119)
- L44: CDROM Extended Architecture (CD-ROM XA aka CD-XA)
- L54: Physical Audio/CDROM Disk Format (ISO/IEC 10149 aka ECMA-130)
- L62: Available Documentation
- L71: Stuff
- L84: Track.Index (stored in subchannel, in BCD format)
- L92: Minute.Second.Sector (stored in subchannel, and in Data sectors, BCD format)
- L114: Subchannels
- L119: Error Correction
- L128: 930h-Byte Sectors
- L140: Sessions
- L162: CDROM Subchannels
- L163: Subchannel P
- L174: Subchannel Q
- L193: Subchannel Q with ADR=1 during Lead-In -- Table of Contents (TOC)
- L219: Subchannel Q with ADR=1 in Data region -- Position
- L229: Subchannel Q with ADR=1 during Lead-Out -- Position
- L240: Subchannel Q with ADR=2 -- Catalogue number of the disc (UPC/EAN barcode)
- L258: Subchannel Q with ADR=3 -- ISRC number of the current track
- L274: Subchannel Q with ADR=5 in Lead-in -- Multisession Lead-In Info
- L300: Subchannel Q with ADR=5 in Lead-Out -- Multisession Lead-Out Info
- L310: Subchannel Q with ADR=5 in Lead-in -- CDR/CDRW Skip Info (Audio Only)
- L343: Subchannel R..W
- L358: Subchannel R..W, when used for CD-TEXT in the Lead-In area
- L452: adjust\_crc\_16\_ccitt(addr\_len)  ;for CD-TEXT and Subchannel Q
- L466: CDROM Sector Encoding
- L467: Audio
- L471: Mode0 (Empty)
- L477: Mode1 (Original CDROM)
- L486: Mode2/Form1 (CD-XA)
- L496: Mode2/Form2 (CD-XA)
- L506: encode\_sector
- L535: calc\_parity(sector,offs,len,j0,step1,step2)
- L551: adjust\_edc(addr,len)
- L559: init\_tables
- L579: subfunc(a,b)
- L589: CDROM Scrambling
- L590: Scrambling
- L626: CDROM XA Subheader, File, Channel, Interleave
- L630: 1st Subheader byte - File Number (FN)
- L635: 2nd Subheader byte - Channel Number (CN)
- L643: 3rd Subheader byte - Submode (SM)
- L659: 4th Subheader byte - Codinginfo (CI)
- L673: Audio/Video Interleave (Multiple Files/Channels)
- L714: Unused sectors in Interleave
- L723: Real Time Streaming
- L737: CDROM XA Audio ADPCM Compression
- L743: Subheader
- L749: ADPCM Sectors
- L778: XA-ADPCM Header Bytes
- L790: XA-ADPCM Data Words (32bit, little endian)
- L809: decode\_sector(src)
- L827: decode\_28\_nibbles(src,blk,nibble,dst,old,older)
- L841: Pos/neg Tables
- L849: Old/Older Values
- L856: 25-point Zigzag Interpolation
- L937: XA-ADPCM Emphasis
- L952: Uninitialized Six-step Counter
- L960: RIFF Headers (on PCs)
- L987: CDROM ISO Volume Descriptors
- L988: System Area (prior to Volume Descriptors)
- L1022: Volume Descriptors (Sector 16 and up)
- L1029: Primary Volume Descriptor (sector 16 on PSX disks)
- L1071: Volume Descriptor Set Terminator (sector 17 on PSX disks)
- L1079: Boot Record (none such on PSX disks)
- L1089: Supplementary Volume Descriptor (none such on PSX disks)
- L1101: Volume Partition Descriptor (none such on PSX disks)
- L1114: Reserved Volume Descriptors (none such on PSX disks)
- L1122: CDROM ISO File and Directory Descriptors
- L1128: Format of a Directory Record
- L1195: Path Tables
- L1206: Format of a Path Table Entry
- L1229: Format of an Extended Attribute Record (none such on PSX disks)
- L1258: CDROM ISO Misc
- L1259: Both Byte Order
- L1272: d-characters (Filenames)
- L1277: a-characters
- L1286: Fixed Length Strings/Filenames
- L1296: Volume Descriptor Timestamps
- L1309: Recording Timestamps
- L1317: File Flags
- L1339: Permission Flags (in Extended Attribute Records)
- L1359: CDROM Extension Joliet
- L1360: Typical Joliet Disc Header
- L1379: Secondary Volume Descriptor (aka Supplementary Volume Descriptor)
- L1402: Directory Records and Path Tables
- L1407: File and Directory Name Characters
- L1415: File and Directory Name Length
- L1433: Official Specs
- L1442: CDROM Protection - SCEx Strings
- L1443: SCEx String
- L1457: Wobble Groove and Absolute Time in Pregroove (ATIP) on CD-R's
- L1472: Other Protections
- L1481: CDROM Protection - Bypassing it
- L1482: Modchips
- L1490: Disk-Swap-Trick
- L1504: Booting via BIOS ROM or Expansion ROM
- L1517: Secret Unlock Commands
- L1523: Booting via Memory Card
- L1536: CDROM Protection - Modchips
- L1537: Modchip Source Code
- L1571: Connection for the data/gate/sync signals:
- L1589: Note on "data" pin (all boards)
- L1596: Note on "gate" pin (older PSX boards only)
- L1604: Note on "sync" pin (newer PSX and PSone boards only)
- L1615: Note on Multi-Region chips
- L1621: Stealth (hidden modchip)
- L1649: NTSC-Boot BIOS Patch
- L1660: MODCHIP Connection Example
- L1681: Nocash BIOS "Modchip" Feature
- L1696: CDROM Protection - Chipless Modchips
- L1709: External Expansion ROM version, for older boards (PU-7 through PU-20):
- L1718: External Expansion ROM version, for newer boards (PU-22):
- L1727: Internal Kernel ROM version, for older boards (PU-7 through PU-20):
- L1733: Internal Kernel ROM version, for newer boards (PU-22 through PM-41(2)):
- L1739: What pin is where...
- L1762: CDROM Protection - LibCrypt
- L1768: Protected sectors generation schemas
- L1786: LibCrypt sectors
- L1817: Example (Legacy of Kain)
