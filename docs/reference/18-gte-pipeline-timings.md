<!-- FONTE: psx-spx/psx-spx.github.io@035c765 docs/gtepipelinetimings.md
...
- L1: GTE Pipeline Timings
- L10: Overview
- L32: Methodology
- L69: Result tables
- L78: Perspective transforms
- L96: Lighting (single-vertex)
- L115: Lighting (triple-vertex)
- L136: Color
- L151: Depth-cue
- L163: Math
- L175: Misc
- L186: MVMVA
- L201: Patterns
- L203: The GTE snapshots its inputs early
- L211: Triple-vertex variants extend the boundary by ~3 nops
- L216: RGBC for NCCT-class triples latches mid-execution
- L226: Depth-queue inputs latch latest among RTPS inputs
- L230: Far Color (FC) latching depends on instruction
- L239: Caveats and methodology limits
- L241: icache layout sensitivity
- L247: Single-console caveat
- L254: Saturation collapse
- L262: "Doesn't affect output" vs "internal latch cycle"
- L271: `LWC2` excluded
- L276: GAS does not auto-insert nops
